...
buttonmultiply=tk.Button(root,text="*",command=lambda:add_to_calculation("*"),width=5,font=("Arial",14))
buttonmultiply.grid(row=4,column=4)
buttondevide=tk.Button(root,text="/",command=lambda:add_to_calculation("/"),width=5,font=("Arial",14))
buttondevide.grid(row=5,column=4)
buttonopen=tk.Button(root,text="(",command=lambda:add_to_calculation("("),width=5,font=("Arial",14))
buttonopen.grid(row=5,column=1)
buttonclose=tk.Button(root,text=")",command=lambda:add_to_calculation(")"),width=5,font=("Arial",14))
buttonclose.grid(row=5,column=3)
buttonequals=tk.Button(root,text="=",command=evalute_calculation,width=11,font=("Arial",14))
